                    ...
                    <div class="address-block">
                        <div class="image">
                            <a href="/fore/foreIndex">
                                <img src="${pageContext.request.contextPath}/assets/images/logo2.png" class="img-fluid" alt="">
                            </a>
                        </div>
                        ...
                        <div class="address-text">
                            <ul>
                                <li>地址: 桂林航天工业学院</li>
                                <li>手机: (110) 888 888 888</li>
                                <li>传真: (120) 888 888 888</li>
                                <li>电子邮箱: 1729704144@qq.com</li>
                            </ul>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left mb-20 mb-md-0">
                    ...
                    <div class="footer-copyright-text">
                        <p>Copyright &copy; 2020 <a href="#">龙勇华</a></p>
                    </div>
