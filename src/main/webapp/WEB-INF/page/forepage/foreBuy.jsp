                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="checkout-payment-method">
                                                        ...
                                                        <div class="single-method">
                                                            <label for="payment_paypal">请选择支付方式：</label>
                                                            <input type="text" id="payment_paypal" onclick="payedFunc(this);" name="payment-method"  list="carsname">
                                                            <datalist id="carsname">
                                                                <option> <label for="payment_paypal">货到付款</label></option>
                                                                <option> <label for="payment_paypal">支付宝</label></option>
                                                            </datalist>
                                                        </div>
...
<script type="text/javascript">
    ...
    function createOrder() {
        ...
        var phone = $("#phone").val();
        var paytypeid=$("#payment_paypal").val();
        ...
        window.location.href=("foreCreateOrder?address="+cstAddress+"&paytypeid="+paytypeid);
