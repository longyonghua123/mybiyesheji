...
<head>
    ...
    <title>时光点餐后台登陆</title>

    <style type="text/css">
        *{padding:0px;margin:0px;}
        body{font-family:Arial, Helvetica, sans-serif;background:url(../../images/2.jpg);font-size:12px;}
        img{border:0;}
        .lg{width:468px;height:468px;margin:100px auto;background:url(../../images/2.jpg) no-repeat;}
        ...
        .bn{width:330px;height:72px;background:url(../../images/2.jpg) no-repeat;border:0;display:block;font-size:18px;color:#FFF;font-family:Arial, Helvetica, sans-serif;font-weight:bolder;cursor:pointer;}
...
<div class="lg">
    <form action="/login" method="POST">
        <div class="lg_top" >
            <input type="" value="                                       时光餐厅" class="bn" />
            <font color="#dc143c"> <center><h3>${error}</h3></center></font>
        </div>
        <div class="lg_main">
            <div class="lg_m_1">
