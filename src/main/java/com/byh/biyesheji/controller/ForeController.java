...
public class ForeController {
    ...
    public String createOrder( Model model,String address,String paytypeid,HttpSession session){
        /*
          提交订单后，设置code，客户id，支付状态，地址
         */
        Order order = new Order();
        Customer customer =(Customer)  session.getAttribute("cst");
      //   paytypeid =(String)  session.getAttribute("paytypeid");
        System.out.print("*************************");
        System.out.print(paytypeid);
        System.out.print("*************************");
        ...
        System.out.println("支付方式"+paytypeid);
        if (paytypeid.equals("支付宝")){
            String forword="../alipaypage/index";
            System.out.println("ssssssssssssssssss:"+ois);
            System.out.println(order);

            System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaaa");
            System.out.println(total);
            model.addAttribute("order", ois);
            model.addAttribute("total", total);
            return forword;
        }else
    ...
    @RequestMapping("/alipaypictrue")
    public String alipaypictrue(String WIDout_trade_no, String WIDtotal_amount, String WIDbody, String WIDsubject, HttpServletRequest request, HttpServletResponse response){
        ...
        String forword="../alipaypage/alipay.trade.page.pay";
      return forword;
    }
    /**
     * 支付成功跳转
...
//业务逻辑部分(请开始你的数据调用)
    ...
    String out_trade_no = "你数据库的商品订单号";
    //付款金额，必填
    String total_amount = "在后台算好的总金额";
    //订单名称，必填
    String subject = "来自数据库的商品名称";
    //商品描述，可空
